...
public class Wolf extends Animal {
	...
	public void tick() {
		...
		// Fåret rör sig och om det hamnar på en position där det är en sheepa, så ska 
		// hälsa ökas till 30 och sheepan försvinna.
...
//		super.move();
		...
		if (position.getX()+x >= 0 && position.getX()+x < pasture.getWidth() && position.getY()+y >= 0
			...
			// Om ja, sätt hälsa till 30 och ta bort sheep.
